...
def originalfit(x):
    #print(x)    
    return math.exp(math.fabs(x))*math.sin(x*math.pi*2)#math.exp(math.sin(x))*math.pow(x,2)+x+2*math.sin(math.pi/4.3-math.pow(x,3))#1.5*math.pow(x,2)-math.pow(x,3)
